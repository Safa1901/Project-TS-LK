...
function createData(
  ...
  return { pult_id, group, panel, phone, name, active};
}

const rows = [
  createData('14918', 1, 'krd_phoenix', '79649003366', 'Александр Ерофеев', 1,),
  createData('14918', 25, 'krd_phoenix', '79968463533', 'Поддубная Екатерина Владимировна', 0,),
  createData('14918', 23, 'krd_phoenix', '79284513470', 'Евдокимов Александр Сергеевич', 0,),
  createData('14918', 35, 'krd_phoenix', '79284271740', 'Худякова Елена Олеговна,', 1),
];
