...
export const NotificationTable = () => {
    ...
    return (
        <div>
        <Button className={classe.btn} variant="contained">Выгрузить в Excel</Button>
            ...
            <Table className={classes.table} aria-label="enhanced table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="left">Тип устройства</TableCell>
                        <TableCell align="left">Тип уведомления</TableCell>
                        <TableCell align="left">Текст уведомления</TableCell>
                        <TableCell align="left">Время уведомления</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {(rowsPerPage > 0
